(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(".seat-free img").on('click', function(e) {
      if(book == 0) {
        $(this).attr("src","../assets_client/images/movie/seat01-free.png");
        book = 1;
      }
      else if(book == 1) {
        $(this).attr("src","../assets_client/images/movie/seat01-booked.png");
        book = 0;
      }
    });
    var bookTwo = 1;  
    $(".seat-free-two img").on('click', function(e) {
      if(bookTwo == 0) {
        $(this).attr("src","../assets_client/images/movie/seat02-free.png");
        bookTwo = 1;
      }
      else if(bookTwo == 1) {
        $(this).attr("src","../assets_client/images/movie/seat02-booked.png");
        bookTwo = 0;
      }
    });
