...
class AttributeController extends BaseController
{
    ...
    {
        $this->setPageTitle('Create Attribute','Create Attribute');
    ...
    public function update(Request $request)
    {
        ...
        return $this->responseRedirectBack('admin.attributes.index','Attribute updated successfully' ,'success',false, false);
    }
